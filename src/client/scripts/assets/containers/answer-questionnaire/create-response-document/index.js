...
class CreateResponseDocument extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: 'something'
...
CreateResponseDocument.propTypes = {
    // children: PropTypes.shapeOf(PropTypes.element)
    match: PropTypes.object,
    history: PropTypes.object
};

CreateResponseDocument.defaultProps = {
    match: null,
    history: null
};

export default withRouter(CreateResponseDocument);
